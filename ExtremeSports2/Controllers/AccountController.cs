        ...
        public async Task<IActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    if (result.Succeeded)
                    {
                        _flashMessage.Info("Contraseña actualizada correctamente.");
                        return RedirectToAction("ChangeUser");
                       
                    }
                    else
                    {
                        _flashMessage.Danger(string.Empty, "La contraseña actual ingresada no es coincide con la contraseña almacenada en el sistema.");
                    }
                }
                else
                {
